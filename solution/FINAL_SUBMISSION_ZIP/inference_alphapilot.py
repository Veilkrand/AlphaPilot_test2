...
class inferenceAlphaPilot():
    ...
    def __init__(self,
        ...
        self.conf_threshold = conf_threshold # Any pixel below this confidence value will not be considered as a detection.
        ...
        self.net.load_state_dict(torch.load(self.checkpoint_path, map_location=device))
